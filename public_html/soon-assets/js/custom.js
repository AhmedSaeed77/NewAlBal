...
var Frost = function() {
    ...
    var WebsiteLaunchDate = '20 September 2022 01:00';
    ...
    var handleFinalCountDown = function() {
        if (jQuery('.countdown-timer').length > 0) {
            var startTime = new Date("September 12 2022 17:00:00"); // Put your website start time here
            startTime = startTime.getTime();

            var currentTime = new Date();
            currentTime = currentTime.getTime();

            var endTime = new Date("September 31 2022 01:00:00"); // Put your website end time here
