    ...
    <div class="container">
        <div class="page-breadcrumb-content text-center">
            <div class="page-breadcrumb-title">
                <h2 class="breadcrumb-head black bold">About <span>Us</span></h2>
            </div>
                                    ...
                                    <div id="accordion-2" class="panel-group">
                                        <div class="reply-comment-box">
                                            <div class="blog-comment-area ul-li about-teacher-2" >
                                                ...
                                                <p style="color:black !important;">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ab alias atque autem consequatur consequuntur cupiditate dolor doloribus est exercitationem harum modi, neque nisi obcaecati pariatur quas quo ratione saepe? Veritatis.</p>

                                                <div class="about-content-text">
                                                    <p style="color:black !important;">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Accusamus ad, alias cum dolorem, ea error fuga fugit iste iure magnam maiores minima nesciunt nisi non ratione reiciendis sapiente sed voluptates.</p>
                                                    <div class="about-btn">
                                                        <div class="genius-btn gradient-bg text-center text-uppercase ul-li-block bold-font">
                                                            <a href="{{route('index')}}#contact-area">contact us <i class="fas fa-caret-right"></i></a>
                                                        </div>
                                                    </div>
                                                </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="copy-right-text">
                            <p>© 2020-2021 - {{env('APP_NAME')}}. All rights reserved</p>
                        </div>
                    </div>
                    <div class="col-md-6">
