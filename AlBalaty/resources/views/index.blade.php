...
@section('content')
    ...
    <div class="hero-banner hero-style-1">
                ...
                <div class="col-lg-6">
                    <div class="banner-content">
                        ...
                        <div class="banner-btn" data-sal-delay="400" data-sal="slide-up" data-sal-duration="1000">
                            <a href="{{route('register')}}" class="edu-btn">سجل الأن</a>
                        </div>
                        <ul class="shape-group">
                            <li class="shape-1 scene" data-sal-delay="1000" data-sal="fade" data-sal-duration="1000">
                                <img data-depth="2" src="{{asset('assets-public/images/about/shape-13.png')}}" alt="Shape">
                            </li>
                        </ul>
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="banner-thumbnail">
                        <div style="height:500px" class="thumbnail" data-sal-delay="500" data-sal="slide-left" data-sal-duration="1000">
                            <img style="height:100% !important" src="{{asset('assets-public/images/banner/girl-1.png')}}" alt="Girl Image">
                        </div>

                        <ul class="shape-group">
                            <li class="shape-1" data-sal-delay="1000" data-sal="fade" data-sal-duration="1000">
                                <img data-depth="1.5" src="{{asset('assets-public/images/about/shape-15.png')}}" alt="Shape">
                            </li>
                            <li class="shape-2 scene" data-sal-delay="1000" data-sal="fade" data-sal-duration="1000">
                                <img data-depth="-1.5" src="{{asset('assets-public/images/about/shape-16.png')}}" alt="Shape">
                            </li>
                            ...
                            <li class="shape-4" data-sal-delay="1000" data-sal="fade" data-sal-duration="1000">
                                <img data-depth="-1" src="{{asset('assets-public/images/counterup/shape-02.png')}}" alt="Shape">
                            </li>
                            <li class="shape-5 scene" data-sal-delay="1000" data-sal="fade" data-sal-duration="1000">
                                <img data-depth="1.5" src="{{asset('assets-public/images/about/shape-13.png')}}" alt="Shape">
                            </li>
                            <li class="shape-6 scene" data-sal-delay="1000" data-sal="fade" data-sal-duration="1000">
                                <img data-depth="-2" src="{{asset('assets-public/images/about/shape-18.png')}}" alt="Shape">
                            </li>
                        </ul>
                    </div>
                </div>
        ...
        <div class="shape-7">
            <img src="{{asset('assets-public/images/about/h-1-shape-01.png')}}" alt="Shape">
        </div>
    </div>
    <!--=====================================-->
    <!--=       Features Area Start      =-->
        ...
        <div class="container">
            <div class="features-grid-wrap">
                <div class="features-box features-style-2 edublink-svg-animate">
                    <div class="icon">
                        <img class="svgInject" src="{{asset('assets-public/images/animated-svg-icons/online-class.svg')}}" alt="animated icon">
                    </div>
                    <div class="content">
                        <h5 class="title"><span>{{$webSiteStatistics->package_no}}</span> باقات اونلاين</h5>
                    </div>
                </div>
                <div class="features-box features-style-2 edublink-svg-animate">
                    <div class="icon">
                        <img class="svgInject" src="{{asset('assets-public/images/animated-svg-icons/instructor.svg')}}" alt="animated icon">
                    </div>
                    <div class="content">
                        <h5 class="title"><span> {{$webSiteStatistics->teacher_no.' '}}من افضل</span>المعلمين</h5>
                    </div>
                </div>
                <div class="features-box features-style-2 edublink-svg-animate">
                    <div class="icon certificate">
                        <img class="svgInject" src="{{asset('assets-public/images/animated-svg-icons/certificate.svg')}}" alt="animated icon">
                    </div>
                    <div class="content">
                ...
                <div class="features-box features-style-2 edublink-svg-animate">
                    <div class="icon">
                        <img class="svgInject" src="{{asset('assets-public/images/animated-svg-icons/user.svg')}}" alt="animated icon">
                    </div>
                    <div class="content">
                        <h5 class="title"><span>{{$webSiteStatistics->student_no}}</span>اعضاء</h5>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row g-5">
                ...
                @foreach($pathsByCountry as $paths)
                   @foreach($paths as $path)
                    <div class="col-lg-4 col-md-6" data-sal-delay="{{ (($loop->index+1) % 3) * 50 }}" data-sal="slide-up" data-sal-duration="800">
                        <a href="{{route('packages-catalog', $path->id)}}" class="w-100">
                            <div class="categorie-grid categorie-style-2 {{$loop->index % 2 ? 'color-tertiary-style': 'color-extra02-style'}}" >
                                <div class="content">
                                    <h5 class="title">
                                        {{$path->title}}
                                        {{-- <p style="margin: 0">
                                            <b>
                                            ( {{$part->package_count}} ) {{$part->package_count > 1 ? 'باقات': 'باقة'}}
                                            </b>
                                        </p> --}}
                                    </h5>
                                </div>
    ...
    <div class="edu-about-area about-style-3">
            ...
            <div class="row g-5 align-items-center">
                ...
                <div class="col-lg-6">
                    <div class="about-image-gallery">
                        <img class="main-img-1" data-sal-delay="100" data-sal="slide-up" data-sal-duration="800" src="{{asset('assets-public/images/course/course-05.jpg')}}" alt="About Image">
                        <img class="main-img-2" data-sal-delay="100" data-sal="slide-left" data-sal-duration="800" src="{{asset('assets-public/images/about/about-05.png')}}" alt="About Image">
                        <ul class="shape-group">
                            <li class="shape-1 scene" data-sal-delay="500" data-sal="fade" data-sal-duration="200">
                                <img data-depth="2" src="{{asset('assets-public/images/about/shape-13.png')}}" alt="Shape">
                            </li>
                            <li class="shape-2 scene" data-sal-delay="500" data-sal="fade" data-sal-duration="200">
                                <img data-depth="-2" src="{{asset('assets-public/images/about/shape-39.png')}}" alt="Shape">
                            </li>
                            <li class="shape-3 scene" data-sal-delay="500" data-sal="fade" data-sal-duration="200">
                                <img data-depth="2" src="{{asset('assets-public/images/about/shape-07.png')}}" alt="Shape">
                            </li>
        ...
        <ul class="shape-group">
            <li class="shape-1">
                <img class="rotateit" src="{{asset('assets-public/images/about/shape-13.png')}}" alt="Shape">
            </li>
            <li class="shape-2">
                <span></span>
            </li>
    ...
    <div class="edu-course-area course-area-1 edu-section-gap bg-lighten01">
        <div class="container">
            ...
            <div class="row g-5">
                ...
                <!-- Start Single Course  -->
                <div class="col-md-6 col-xl-3" data-sal-delay="{{150 + ($loop->index*50) }}" data-sal="slide-up" data-sal-duration="800">
                ...
                <div class="col-lg-8">
                    <div class="counterup-box-wrap">
                        ...
                        <ul class="shape-group">
                            ...
                            <li class="shape-2">
                                <img class="rotateit" src="{{asset('assets-public/images/counterup/shape-02.png')}}" alt="Shape">
                            </li>
                            <li class="shape-3 scene">
                                <img data-depth="1.6" src="{{asset('assets-public/images/counterup/shape-04.png')}}" alt="Shape">
                            </li>
                            <li class="shape-4 scene">
                                <img data-depth="-1.6" src="{{asset('assets-public/images/counterup/shape-05.png')}}" alt="Shape">
                            </li>
                        </ul>
                    </div>
                </div>
                        ...
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <div class="testimonial-grid">
                                    <div class="thumbnail">
                                        <img src="{{asset('assets-public/images/testimonial/testimonial-01.png')}}" alt="Testimonial">
                            ...
                            <div class="swiper-slide">
                                <div class="testimonial-grid">
                                    <div class="thumbnail">
                                        <img src="{{asset('assets-public/images/testimonial/testimonial-02.png')}}" alt="Testimonial">
                                        <span class="qoute-icon"><i class="icon-26"></i></span>
                            ...
                            <div class="swiper-slide">
                                <div class="testimonial-grid">
                                    <div class="thumbnail">
                                        <img src="{{asset('assets-public/images/testimonial/testimonial-03.png')}}" alt="Testimonial">
                                        <span class="qoute-icon"><i class="icon-26"></i></span>
                            ...
                            <div class="swiper-slide">
                                <div class="testimonial-grid">
                                    <div class="thumbnail">
                                        <img src="{{asset('assets-public/images/testimonial/testimonial-04.png')}}" alt="Testimonial">
                                        <span class="qoute-icon"><i class="icon-26"></i></span>
  ...
  <div class="edu-course-area course-area-1 edu-section-gap bg-lighten01">
                ...
                <div class="col-md-6 col-xl-3" data-sal-delay="{{150 + ($loop->index*50) }}" data-sal="slide-up" data-sal-duration="800">
                    <div class="edu-course course-style-1 hover-button-bg-white">
                        <div class="inner">
                            <div class="thumbnail">
                                <a href="">
                                    <img src="{{$event->img}}" alt="{{$event->name}}" style="height: 300px;">
                                </a>
                                <div class="time-top">
                                    <span class="duration bg-danger"><i class="icon-50"></i> {{ $event->teacher->name ?? '' }}</span>
                                </div>
                            </div>
                            <div class="content">
                                <span class="course-level">{{ $event->lang }}</span>
                                <h6 class="title">
                                    <a href="{{route('public.event.view', $event->id)}}">{{ $event->name }}</a>
                                </h6>
                                {{--
                                <div class="course-rating">
                                    <div class="rating">
                                ...
                                --}}
                                <div class="course-price">{{ $event->price }} </div>
                                <ul class="course-meta d-flex">
                                    <li class="d-flex flex-row-reverse flex-row">
                                        <i class="icon-24"></i>
                                        {{-- {{ $package->videos_count }} --}}
                        ...
                        <div class="course-hover-content">
                            <div class="content">
                                ...
                                <a href="{{route('public.event.view', $event->id)}}" class="edu-btn btn-secondary btn-small">اشترك الان <i class="icon-4"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="home-one-cta edu-cta-box bg-image">
                        ...
                        <ul class="shape-group">
                            <li class="shape-01 scene">
                                <img data-depth="2" src="{{asset('assets-public/images/cta/shape-06.png')}}" alt="shape">
                            </li>
                            <li class="shape-02 scene">
                                <img data-depth="-2" src="{{asset('assets-public/images/cta/shape-12.png')}}" alt="shape">
                            </li>
                            <li class="shape-03 scene">
                                <img data-depth="-3" src="{{asset('assets-public/images/cta/shape-04.png')}}" alt="shape">
                            </li>
                        </ul>
                    </div>
                </div>
    ...
    <div class="edu-team-area team-area-1 gap-tb-text">
        ...
        <!--    @foreach(\App\Models\Auth\Admin::orderBy('created_at', 'desc')->get()->take(4) as $admin)-->
        ...
        <!--                                    <img src="{{asset('assets-public/images/team/team-01.jpg')}}" alt="team images">-->
        <!--                                </a>-->
        <!--                            </div>-->
        ...
        <!--                        </div>-->
        <!--                        <div class="content">-->
        <!--                            <h5 class="title"><a href="#">{{$admin->name}}</a></h5>-->
        <!--                            <span class="designation">{{$admin->country}}</span>-->
        <!--                        </div>-->
        <!--                    </div>-->
        <!--                </div>-->
        <!--            </div>-->
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-7">
                        <div class="section-title section-center" data-sal-delay="150" data-sal="slide-up" data-sal-duration="800">
                            ...
                            <a href="{{route('register')}}" class="edu-btn">ابدا الان <i class="icon-4"></i></a>
                        </div>
                    </div>
                </div>
                <ul class="shape-group">
                    <li class="shape-01 scene">
                        <img data-depth="2.5" src="{{asset('assets-public/images/cta/shape-10.png')}}" alt="shape">
                    </li>
                    <li class="shape-02 scene">
                        <img data-depth="-2.5" src="{{asset('assets-public/images/cta/shape-09.png')}}" alt="shape">
                    </li>
                    <li class="shape-03 scene">
                        <img data-depth="-2" src="{{asset('assets-public/images/cta/shape-08.png')}}" alt="shape">
                    </li>
