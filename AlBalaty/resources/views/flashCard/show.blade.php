                                ...
                                <div class="row">
                                    <div class="col-md-10 col-md-offset-1">
                                        ...
                                        <div class="row" style="border-bottom: 1px solid #ccc; padding: 10px 0;">
                                            <div class="col-md-11">
                                                <h5><b>{{\App\Models\Auth\User::find($comment->user_id)->name}}</b> <i style="color:#333;">{{$comment->created_at->diffForHumans()}}</i></h5>
                                                <p>{{$comment->contant}}</p>
                                            ...
                                            <div class="row" id="replies" style="">
                                                ...
                                                <div class="col-md-10 col-md-offset-2">
                                                    <h5><b>{{\App\Models\Auth\User::find($reply->user_id)->name}}</b> <i style="color:#333;">{{$reply->created_at->diffForHumans()}}</i></h5>
                                                    <p>{{$reply->contant}}</p>
                                                </div>
                                                @endforeach
                                            </div>
