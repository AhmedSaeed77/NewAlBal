...
@section('content')
        ...
        <div class="section-small pt-0" >
            ...
            <div class="course-grid-slider" uk-slider="finite: true">
                ...
                <ul class="uk-slider-items uk-child-width-1-4@m uk-child-width-1-3@s uk-grid">
                    @foreach(\App\Event::get(['id']) as $event__)
                        <li>
                        @php
                                ...
                                <div class="course-card">
                                    ...
                                    <div class="course-card-body">
                                        ...
                                        @php
                                            ...
                                            $numberVideos = Cache::remember('event'.$event->id.'videosCount', 1440, function()use($event){
                                                $videos_arr = [];
                                        ...
                                        @php
                                            $package_hours = Cache::remember('event'.$event->id.'hoursCount', 1440, function()use($event){
                                                $total_hours = 0;
                                                $total_min = 0;
                                                $total_sec = 0;
