                    ...
                    <ul class="menu-nav">
                                ...
                                <ul class="menu-subnav">
                                    ...
                                    <li class="menu-item" aria-haspopup="true">
                                        <a href="{{route('library.create')}}" class="menu-link">
                                            ...
                                            <span class="menu-text">New {{config('library.path.en')}}</span>
                                        </a>
                                    </li>
                        ...
                        <li class="menu-item menu-item-submenu" data-menu-toggle="hover" aria-haspopup="true">
                            ...
                            <div class="menu-submenu menu-submenu-classic menu-submenu-right">
                                <ul class="menu-subnav">
                                    <li class="menu-item" aria-haspopup="true">
                                        <a href="{{route('super-admin.package-manager.index')}}" class="menu-link">
                                            <i class="menu-bullet menu-bullet-dot">
                                                <span></span>
                                            </i>
...
{{--                                <ul class="menu-subnav">--}}
{{--                                    <li class="menu-item" aria-haspopup="true">--}}
{{--                                        <a href="{{route('transactions.show')}}" class="menu-link">--}}
{{--                                            <i class="menu-bullet menu-bullet-dot">--}}
{{--                                                <span></span>--}}
{{--                                            </i>--}}
...
{{--                        </li>--}}
                        ...
                        <li class="menu-item menu-item-submenu" data-menu-toggle="hover" aria-haspopup="true">
                            ...
                            <div class="menu-submenu menu-submenu-classic menu-submenu-right">
                                <ul class="menu-subnav">
                                    <li class="menu-item" aria-haspopup="true">
                                        <a href="{{route('super-admin.event.index')}}" class="menu-link">
                                            <i class="menu-bullet menu-bullet-dot">
                                                <span></span>
                                            </i>
                                            <span class="menu-text">Events</span>
...
{{--                            <div class="menu-submenu menu-submenu-classic menu-submenu-right">--}}
{{--                                <ul class="menu-subnav">--}}
{{--                                    @foreach(\App\Models\Library\Path::all() as $path)--}}
{{--                                        <li class="menu-item" aria-haspopup="true">--}}
{{--                                            <a href="{{route('statics.index', $path->id)}}" class="menu-link">--}}
{{--                                                <i class="menu-bullet menu-bullet-dot">--}}
{{--                                                    <span></span>--}}
{{--                                                </i>--}}
{{--                                                <span class="menu-text">{{$path->title}}</span>--}}
{{--                                            </a>--}}
{{--                                        </li>--}}
{{--                                    @endforeach--}}
{{--                                </ul>--}}
                ...
                <div class="subheader py-2 py-lg-4 subheader-solid" id="kt_subheader">
                    <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
                        ...
                        <div class="d-flex align-items-center flex-wrap mr-2">
                            <!--begin::Page Title-->
                            <h5 class="text-dark font-weight-bold mt-2 mb-2 mr-5">@yield('subheaderTitle')</h5>
                            <!--end::Page Title-->
                        </div>
                        <!--end::Info-->
                        <!--begin::Toolbar-->
