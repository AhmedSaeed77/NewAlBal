        ...
        <form class="form-horizontal form-bordered" method="POST" action="{{route('faq.update', $q->id)}}" id="faqForm">
            ...
            <div class="card-body">
                ...
                <div class="form-group-lg py-5 row">
                    ...
                    <div class="col-md-5">
                        <input class="form-control" type="text" placeholder="Title" value="{{Transcode::evaluate($q,1)['title']}}" name="title_ar"/>
                    </div>
                ...
                <div class="form-group-lg py-5 row">
                    ...
                    <div class="col-md-5">
                        <textarea id="kt-ckeditor-1" class="form-control" maxlength="250" rows="2" name="content" placeholder="This textarea has a limit of 225 chars.">
                            {!! $q->contant!!}
                        </textarea>
                    </div>
                    <div class="col-md-5">
                        <textarea id="kt-ckeditor-2" class="form-control" maxlength="250" rows="2" name="content_ar" placeholder="This textarea has a limit of 225 chars.">
                            {!!Transcode::evaluate($q,1)['contant']!!}
                        </textarea>
                    </div>
                </div>
            </div>
