...
@section('pageTitle') Add {{config('library.explanation.en')}} @endsection

@section('subheaderTitle') Add {{config('library.explanation.en')}} @endsection
        ...
        <div id="questionAddForm" class="vueform">
            <div class="card-body">
                ...
                <div class="form-group-lg py-5 row">
                    ...
                    <div class="col-10">
                        <textarea class="form-control " id="explanationEditor" @change="livePreview" placeholder="Question" rows="5"></textarea>
                    </div>
                </div>
                <div class="form-group-lg py-5 row">
            ...
            methods:{
                ...
                store:async function(){
                    ...
                    await this.storeRequest().then((res) => {
                        ...
                        console.log(res);
                        swal({
                            text: 'Explanation Added.',
                            type: "success",
                            buttonsStyling: false,
                            confirmButtonText: "Ok, got it!",
                            confirmButtonClass: "btn font-weight-bold btn-light"
                        }).then(function () {
                            window.location.href = '{{route('explanation.create')}}';
                        });
                    });
                },
