                                                        ...
                                                        @foreach($messages as $msg)
                                                            @php
                                                                ...
                                                                if($msg->from_user_id == Auth::user()->id && $msg->from_user_type == 'admin'){
                                                                    ...
                                                                    if(\App\Models\Auth\User::find($msg->to_user_id)){
                                                                        $user = \App\Models\Auth\User::find($msg->to_user_id);
                                                                    }else{
                                                                        $user= \App\DisabledUser::find($msg->to_user_id);
                                                                    }
                                                                }else{
                                                                    if(\App\Models\Auth\User::find($msg->from_user_id)){
                                                                        $user= \App\Models\Auth\User::find($msg->from_user_id);
                                                                    }else{
									...
									<div class="kt-chat">
										<div class="kt-portlet kt-portlet--head-lg kt-portlet--last">
                                            ...
                                            @php
                                                ...
                                                if(\App\Models\Auth\User::find(Illuminate\Support\Facades\Input::get('user_id'))){
                                                    $user = \App\Models\Auth\User::find(Illuminate\Support\Facades\Input::get('user_id'));
                                                }else{
