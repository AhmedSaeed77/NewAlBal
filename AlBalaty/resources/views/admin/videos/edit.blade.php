        ...
        <form class="vueform">
            <div class="card-body">
                ...
                <div class="form-group-lg py-5 row">
                    ...
                    <div class="col-5">
                        <input class="form-control" type="text" placeholder="عربي" name="title_ar" v-model="title_ar"/>
                    </div>
                </div>
                ...
                <div class="form-group  row">
                    ...
                    <div class="col-5">
                        <textarea class="form-control " placeholder="الوصف" rows="5" name="description_ar" v-model="description_ar"></textarea>
                    </div>
                </div>
                <div class="form-group row">
    ...
    <script>
        ...
        var app = new Vue({
            ...
            data:{
                ...
                chapter:'{{\App\Chapters::find($video->chapter)->name}}',         // ###
            ...
            methods:{
                ...
                submit: function(){
                    ...
                    if(this.description == '' || this.description_ar == ''){
                        $('.note').show();
                        this._('note_text').innerHTML = 'Description is required !';
                        error =1;
                    }

                    if(this.title == '' || this.title_ar == ''){
                        $('.note').show();
