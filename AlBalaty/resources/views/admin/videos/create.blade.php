    ...
    <div class="card card-custom p-6">
        ...
        <form class="vueform">
            ...
            <div class="card-body" v-if="fileUploaded">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <label class="col-form-label" for="exampleSelectd1">{{config('library.path.en')}}</label>
                    ...
                    <div class="col-md-6">
                        <label class="col-form-label" for="exampleSelectd1">{{config('library.course.en')}}</label>
                ...
                <div class="row">
                    <div class=" col-md-6">
                        <label class="col-form-label" for="exampleSelectd1">{{config('library.part.en')}}</label>
                    ...
                    <div class="col-md-6">
                        <label class="col-form-label" for="exampleSelectd1">{{config('library.chapter.en')}}</label>
                ...
                <div class="row mb-5">
                    <div class="col-md-6">
                        <label class="col-form-label" for="exampleSelectd1">{{config('library.topic.en')}}</label>
            ...
            methods:{
                ...
                dropZoneInit: function(){
                    this.dropZone = $('#fileUploaderDropZone').dropzone({
                        ...
                        acceptedFiles: "video/*",
                        // addRemoveLinks: true,
                        url: "{{route('vimeo.chunk.upload')}}", // Set the url for your upload script location
                ...
                loadUnlinkedAttachment: async function(){
                    ...
                    return $.ajax({
                        type: 'POST',
                        url: '{{route('video.get.unlinked.attachment')}}',
                    });
                },
                ...
                addAttachment: function(){
                    ...
                    ajax.open("POST" ,"{{ route('upload.video.attachment.request') }}");
                    ajax.send(formdata);
                    $("#progress2").show();
                ...
                deleteAttachment: function(idx){
                    ...
                    return $.ajax ({
                        type: 'POST',
                        url: '{{ route('video.delete.unlinked.attachment')}}',
                        data:{
