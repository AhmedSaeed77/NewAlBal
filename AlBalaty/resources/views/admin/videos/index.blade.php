...
@section('subheaderNav')
    <a href="{{route('video.create')}}" class="btn btn-fh btn-white btn-hover-primary font-weight-bold px-2 px-lg-5 mr-2">
...
@section('header-form')
    ...
    <form action="{{route('video.index')}}" method="GET" class="d-flex" id="searchForm">
        ...
        <select class="form-control form-control-sm mr-3" id="path_id" name="path_id" v-on:change="getCourses" v-model="path_id">
            <option value="">{{config('library.path.en')}}</option>
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <div class="d-flex flex-column flex-grow-1">
                                <a href="#" class="text-dark-75 text-hover-primary mb-1 font-size-lg font-weight-bolder">{{substr($q->title, 0, 80)}}</a>
                                <div class="d-flex">
                                    <div class="d-flex align-items-center">
                            ...
                            <div class="dropdown dropdown-inline ml-2" data-toggle="tooltip" title="" data-placement="left" data-original-title="Quick actions">
                                ...
                                <div class="dropdown-menu p-0 m-0 dropdown-menu-md dropdown-menu-right">
                                    ...
                                    <ul class="navi navi-hover">
                                        ...
                                        <li class="navi-item">
{{--                                            <a href="{{ route('video.edit', $q->id) }}" class="navi-link">--}}
...
{{--                                            </a>--}}
                                        ...
                                        <li class="navi-item">
                                            <a href="#" class="navi-link" data-toggle="modal" data-target="#DeleteModal-{{$q->id}}">
                                                <span class="navi-icon">
                        ...
                        <!--begin::Bottom-->
                        <div class="pt-3">
                            <div class="bgi-no-repeat bgi-size-cover rounded min-h-295px" style="background-image: url({{$q->cover_image}})"></div>
                        </div>
                        <!--end::Bottom-->
                        <!--begin::Separator-->
                        ...
                        <div class="d-flex justify-content-between">
                            <div class="d-flex align-items-center pr-5">
                                ...
                                <span class="text-muted font-weight-bold">{{$q->created_at}}</span>
                            </div>
                            <div class="d-flex align-items-center pr-5">
                            <span class="svg-icon svg-icon-md svg-icon-primary pr-1">
                                ...
                                <span class="text-muted font-weight-bold">{{$q->duration}}</span>
                            </div>
                        </div>
                ...
                <div class="modal-dialog">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            ...
                            {!! Form::open(['action'=>['Admin\VimeoController@destroy', $q->id], 'method'=>'POST']) !!}
            ...
            <div class="card card-custom">
                <div class="card-body">
                    ...
                    <div class="d-flex justify-content-between align-items-center flex-wrap">
                        ...
                        <form class="d-flex align-items-center" method="GET" action="{{route('video.index')}}">
                            <select class="form-control form-control-sm text-primary font-weight-bold mr-4 border-0 bg-light-primary" style="width: 75px;" name="pagination" onchange="this.form.submit()">
                                <option value="1" {{request()->pagination == 10 ? 'selected': ''}}>10</option>
                                <option value="2" {{request()->pagination == 20 ? 'selected': ''}}>20</option>
                            ...
                            <span class="text-muted">Displaying {{$result_counter}} of {{$videos->total()}} records</span>
                        </form>
                    </div>
                    <!--end:: Pagination-->
                </div>
...
@section('jscode')
    ...
    <script>
        ...
        var app = new Vue({
            el: '#searchForm',
            data:{
                path_id: '{{request()->course_id}}',
                course_id: '{{request()->chapter}}',
                course_data: [],
            },
            mounted(){
                this.getCourses();
