...
{{--                    <label class="col-2 col-form-label">Include a Passage</label>--}}
{{--                    <div class="col-10">--}}
{{--                        <input type="checkbox" v-model="includePassage" class="form-control-sm"/>--}}
{{--                    </div>--}}
{{--                </div>--}}
                ...
                <div class="form-group row">
                    ...
                    <div class="col-10">
                        <select class="form-control" id="exampleSelectd1" v-model="question_type_id">
                            @foreach(App\Models\Material\Question\QuestionType::all() as $type)
                ...
                <div class="form-group row">
                    ...
                    <div class=" col-10">
                        <select class="form-control" id="" v-model="exam_num" multiple>
                            <optgroup>
                                @foreach(\App\Models\Library\Exam::where('admin_created_by', Auth::user()->id)->get() as $exam)
