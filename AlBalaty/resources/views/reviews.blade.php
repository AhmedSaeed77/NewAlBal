...
@section('content')
    ...
    <section class="about-one about-one__about-page">
        <img src="{{asset('public_assets/images/circle-stripe.png')}}" class="about-one__circle" alt="">
        <div class="container text-center">
            ...
            <div class="about-one__img">
                <div class="row">
                    <div class="col-lg-6">
                        <img src="{{asset('public_assets/images/about-2-1.jpg')}}" alt="">
                    </div><!-- /.col-lg-6 -->
                    <div class="col-lg-6">
                        <img src="{{asset('public_assets/images/about-2-2.jpg')}}" alt="">
                    </div><!-- /.col-lg-6 -->
                </div><!-- /.row -->
                <div class="about-one__review">
                    <p class="about-one__review-count counter">{{Cache::remember('userCount', 1440, function(){ return \App\Models\Auth\User::all()->count();})}}</p><!-- /.about-one__review-count -->
            ...
            <a href="{{route('index')}}" class="thm-btn about-one__btn">Start Learning Now</a><!-- /.thm-btn -->
        </div><!-- /.container -->
                ...
                <div class="col-xl-4 col-lg-6 col-md-6 col-sm-12">
                    <div class="team-one__single">
                        <div class="team-one__image">
                            <img src="{{asset('public_assets/images/team-1-1.jpg')}}" alt="">
                        </div><!-- /.team-one__image -->
    ...
    <section class="video-one">
        <div class="container">
            <img src="{{asset('public_assets/images/scratch-1-1.png')}}" class="video-one__scratch" alt="">
            <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="video-one__img">
                        <img src="{{asset('public_assets/images/video-1-1.jpg')}}" alt="">
    ...
    <section class="brand-one  ">
        <div class="container">
            <div class="brand-one__carousel owl-carousel owl-theme">
                <div class="item">
                    <img src="{{asset('public_assets/images/brand-1-1.png')}}" alt="">
                </div><!-- /.item -->
                <div class="item">
                    <img src="{{asset('public_assets/images/brand-1-1.png')}}" alt="">
                </div><!-- /.item -->
        ...
        <div class="container">
            ...
            <div class="testimonials-one__carousel owl-carousel owl-theme">
                ...
                @foreach($feedback as $feed)
                    @php $fuser = \App\Models\Auth\User::find($feed->user_id); @endphp
                    @if($fuser)
                    <div class="item">
                        <div class="testimonials-one__single">
                            <div class="testimonials-one__qoute">
                                <img src="{{asset('public_assets/images/qoute-1-1.png')}}" alt="">
                            </div><!-- /.testimonials-one__qoute -->
                            <p class="testimonials-one__text">{{$feed->feedback}}</p><!-- /.testimonials-one__text -->
                            <img src="{{asset('public_assets/images/team-1-1.jpg')}}" alt="" class="testimonials-one__img">
                            <h3 class="testimonials-one__name">{{\App\Models\Auth\User::find($feed->user_id)->name}}</h3><!-- /.testimonials-one__name -->
                            <p class="testimonials-one__designation">Student</p><!-- /.testimonials-one__designation -->
                            <p class="testimonials-one__designation">{{$feed->created_at->diffForHumans()}}</p><!-- /.testimonials-one__designation -->
    ...
    <section class="cta-one cta-one__home-one" style="background-image: url({{asset('public_assets/images/cta-bg-1-1.jpg')}});">
        <div class="container">
