                                ...
                                <div class="col-lg-4">
                                    ...
                                    <select name="product" id="product" class="form-control" v-model="product">
                                        ...
                                        <optgroup label="Packages">
                                            ...
                                            @php
                                                $packages = \App\Models\Package\Packages::where('path_id', $path_id)->orderBy('created_at', 'desc')->get();
                                            @endphp
...
{{--                                    </div>--}}
                                    ...
                                    <div class="col-md-2">
                                        ...
                                        <div class="widget-thumb widget-bg-color-white text-uppercase margin-bottom-20 bordered">
                                            ...
                                            <div class="widget-thumb-wrap">
                                                <div class="widget-thumb-body">
                                                    <span class="widget-thumb-body-stat" data-counter="counterup">@{{total_payments_revenue}}</span>
                                                    USD
                                                </div>
                                            </div>
                                        </div>
...
@section('jscode')
    ...
    <script>
        app = new Vue({
            ...
            computed: {
                total_payments_revenue: function(){
                    total = 0;
                    for (const [key, value] of Object.entries(this.payments)) {
                        total += parseFloat(value.translate_amount);
                    }
