...
@section('content')
    <div class="card card-custom">
        ...
        <div class="card-body">
            {!! Form::open(['action'=>'\App\Http\Controllers\SuperAdmin\TeacherManagerController@index', 'method'=>'GET', 'class'=>'', 'style'=>'margin: 10px 0 20px 0;']) !!}
            <div class="row">
                ...
                <div class="card-body pt-4">
                    ...
                    <div class="d-flex align-items-end mb-7">
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <div class="d-flex flex-column">
                                ...
                                <span class="text-muted font-weight-bold">{{$teacher->phone}}</span>
                            </div>
                            <!--end::Title-->
                        </div>
                        <!--end::Title-->
                    ...
                    <div class="mb-7">
                        ...
                        <div class="d-flex justify-content-between align-items-cente my-1">
                            ...
                            <a href="#" class="text-muted text-hover-primary">{{$teacher->country}}</a>
                        </div>
                        <div class="d-flex justify-content-between align-items-center">
                            <span class="text-dark-75 font-weight-bolder mr-2">Gender:</span>
                            <span class="text-muted font-weight-bold">{{$teacher->gender}}</span>
                        </div>
                        <div class="d-flex justify-content-between align-items-center">
                            <span class="text-dark-75 font-weight-bolder mr-2">Joined:</span>
                            <span class="text-muted font-weight-bold">{{\Carbon\Carbon::parse($teacher->created_at)->diffForHumans()}}</span>
                        </div>
                    </div>
                    <!--end::Info-->
                    <a href="{{route('teacher.edit', $teacher->id)}}" class="btn btn-block btn-sm btn-light-warning font-weight-bolder text-uppercase py-4">Edit</a>
                </div>
                <!--end::Body-->
            </div>
            <!--end::Card-->
        ...
        <div class="card-body">
            ...
            <div class="d-flex justify-content-between align-items-center flex-wrap">
                ...
                <form class="d-flex align-items-center" method="GET" action="{{request()->fullUrl()}}">
                    ...
                    @endforeach
                    <span class="text-muted">Displaying {{count($teachers)}} of {{$teachers->total()}} records</span>
                </form>
            </div>
            <!--end:: Pagination-->
        </div>
