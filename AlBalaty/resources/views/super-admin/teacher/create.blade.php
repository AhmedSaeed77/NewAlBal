...
@section('subheaderTitle')
    ...
    <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold my-2 p-0">
        ...
        <li class="breadcrumb-item">
            <a href="#" class="text-muted">Add Teacher</a>
        </li>
    </ul>
    <!--end::Breadcrumb-->
@endsection
                    ...
                    <div class="wizard wizard-1" id="kt_wizard" data-wizard-state="first" data-wizard-clickable="false">
                        ...
                        <div class="row justify-content-center my-10 px-8 my-lg-15 px-lg-10">
                            <div class="col-xl-12 col-xxl-7">
                                <!--begin::Wizard Form-->
                                <form class="form fv-plugins-bootstrap fv-plugins-framework" id="kt_form" method="POST" action="{{route('teacher.store')}}">
                                    ...
                                    <div class="pb-5" data-wizard-type="step-content" data-wizard-state="current">
                                        ...
                                        <div class="form-group fv-plugins-icon-container">
                                            ...
                                            <input type="text" class="form-control form-control-solid form-control-lg" name="name" placeholder="Teacher Full Name" value="">
                                        ...
                                        <div class="form-group fv-plugins-icon-container">
                                            <label>E-Mail</label>
                                            <input type="text" class="form-control form-control-solid form-control-lg" name="email" placeholder="email" value="">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control form-control-solid form-control-lg" name="phone" placeholder="Phone Number" value="">
                                        ...
                                        <div class="row">
                                            <div class="col-xl-6">
                                                <div class="form-group fv-plugins-icon-container">
                                                    <label>Gender</label>
                                                    <select name="gender" class="form-control form-control-solid form-control-lg" placeholder="Gender">
                                        ...
                                        <div class="row">
                                            <div class="col-xl-12">
                                                <div class="form-group fv-plugins-icon-container">
                                                    ...
                                                    <input type="password" class="form-control form-control-solid form-control-lg" name="password" placeholder="Account New Password">
        ...
        var KTWizard1 = function () {
            ...
            var app = new Vue({
                ...
                data: {
                    ...
                    branch_id: 0,
                    level: 0,
                    selected_management_title: '',
                    management_arr: [], // use to display in step 2
                    checkedManagement: [],  // store data from step 2

                    checkedManagement_key_val: [], // store generated data and display in step 3
                    sections_arr: [],
                    units_arr: [],
                    jobs_arr: [],
                    branches_arr: [],
