                    ...
                    <div class="wizard-steps">
                        ...
                        <div class="wizard-step" data-wizard-type="step" data-wizard-state="pending">
                            <div class="wizard-wrapper">
                                ...
                                <div class="wizard-label">
                                    <h3 class="wizard-title">Define {{config('library.level.en')}}</h3>
                                    <div class="wizard-desc">attach {{config('library.level.en')}} to {{config('library.skill.en')}}</div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="offset-xxl-2 col-xxl-8">
                            <form class="form fv-plugins-bootstrap fv-plugins-framework" id="kt_form">
                                ...
                                <div class="pb-5" data-wizard-type="step-content">
                                    ...
                                    <div class="from-group row">
                                        <div class="col-xl-12">
                                            ...
                                            <div class="form-group fv-plugins-icon-container">
                                                <label>{{config('library.path.en')}} Title</label>
                                                <input type="text" class="form-control form-control-solid form-control-lg" v-model="course_title" placeholder="{{config('library.path.en')}}">
                                                <span class="form-text text-muted">Please enter {{config('library.path.en')}} title.</span>
                                                <div class="fv-plugins-message-container"></div>
                                ...
                                <!--begin: Wizard Step 7-->
                                <div class="pb-5" data-wizard-type="step-content">
                                    <h4 class="mb-10 font-weight-bold text-dark">Define {{config('library.level.en')}}</h4>
                                    <div class="from-group row">
                                        <div class="col-xl-12">
                                            <div class="form-group fv-plugins-icon-container">
                                                <label>{{config('library.course.en')}}</label>
                                        ...
                                        <div class="col-xl-12">
                                            <div class="form-group fv-plugins-icon-container">
                                                ...
                                                <span class="form-text text-muted">Please select {{config('library.topic.en')}}.</span>
                                                <div class="fv-plugins-message-container"></div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-xl-12">
                                            <div class="form-group fv-plugins-icon-container">
                                                <label>{{config('library.skill.en')}}</label>
                                                <div v-for="(course, course_idx) in courses" v-if="course_index == course_idx">
                                                ...
                                                <span class="form-text text-muted">Please select {{config('library.skill.en')}}.</span>
                                                <div class="fv-plugins-message-container"></div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-xl-12">
                                            <!--begin::Input-->
                                            <div class="form-group fv-plugins-icon-container">
                                                <label>{{config('library.level.en')}} Title</label>
                                                <input type="text" class="form-control form-control-solid form-control-lg" v-model="level_title" placeholder="{{config('library.level.en')}} ..">
                                                <span class="form-text text-muted">Please enter {{config('library.level.en')}} title.</span>
                                                <div class="fv-plugins-message-container"></div>
                ...
                methods: {
                        ...
                        Swal.fire({
                            ...
                            if (result.value) {
                                Swal.fire({
                                    ...
                                    /* Read more about isConfirmed, isDenied below */
                                    if (result.value) {
                                        fetch('{{route('library.single.destroy', '')}}/' + topic_type, {
                                            method: 'POST',
                                            headers: {
                    ...
                    update: function(){
                        ...
                        $.ajax ({
                            ...
                            url: '{{ route('library.update', $path_id)}}',
                            success: function(res){
                                console.log(res);
                                KTApp.unblockPage();
                                swal({
                    ...
                    addLevel: function(){
                        if(this.is_empty(this.course_index, '{{config('library.course.en')}} is required !')){
                            return;
                        }
                        if(this.is_empty(this.part_index, '{{config('library.part.en')}} is required !')){
                            return;
                        }
                        if(this.is_empty(this.chapter_index, '{{config('library.chapter.en')}} is required !')){
                            return;
                        }
                        if(this.is_empty(this.topic_index, '{{config('library.topic.en')}} title is required !')){
                            return;
                        }
                        if(this.is_empty(this.skill_index, '{{config('library.skill.en')}} title is required !')){
                            return;
                        }
                        if(this.is_empty(this.level_title, '{{config('library.level.en')}} title is required !')){
                            return;
                        }
