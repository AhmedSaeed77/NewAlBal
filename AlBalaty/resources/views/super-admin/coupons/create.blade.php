...
@section('content')
    ...
    <div class="row" style="background-color: white; padding: 0 0;">
        <div class="col-md-12">
            ...
            <form action="{{ route('coupon.generate') }}" id="newCouponForm" method="POST" enctype="multipart/form-data" class="form-horizontal" style="background: white; padding: 30px 15px;">
                @csrf
                ...
                <div class="form-group form-md-line-input">
                    ...
                    <div class="col-md-8">
                        <select name="package_id" id="package_id" class="form-control">
                            ...
                            @foreach(\App\Models\Package\Packages::where('active','=', 1)->get() as $package)
