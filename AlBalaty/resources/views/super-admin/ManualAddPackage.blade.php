                    ...
                    <div class="form-group form-md-line-input">
                        ...
                        <div class="col-md-8">
                            ...
                            <select type="text" class="form-control input-sm" name="package_id" >
                                ...
                                @foreach(\App\Models\Package\Packages::all() as $package)
                ...
                <div class="form-horizontal form-md-line-input" style="background: white; padding: 30px 15px; margin-top:20px;">
                    <table class="table table-bordered table-hover table-checkable" id="kt_datatable" style="margin-top: 13px !important">
                        ...
                        @foreach(\App\UserPackages::where('user_id', '=' ,$user->id)->orderBy('created_at','desc')->get() as $package)
                            <tr>
                                <td>{{\App\Models\Package\Packages::find($package->package_id)->name}}</td>
                                <td>{{\App\Models\Package\Packages::find($package->package_id)->price}}</td>
                                <td>{{\Carbon\Carbon::parse($package->created_at)->addDays((\App\Models\Package\Packages::find($package->package_id))->expire_in_days) }}</td>
                                <td>
