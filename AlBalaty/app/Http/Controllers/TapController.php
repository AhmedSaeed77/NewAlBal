...
use App\Payment\Payment as PaymentUtility;
use App\Payments;
...
class TapController extends Controller
{
    ...
    public function TAP_Charge(Request $req){
        ...
        $charge_request = [
            ...
            'statement_descriptor' => substr($item->name, 0, 50),
            'metadata' => [
                'coupon' => $coupon_code,
                'item_type' => $item_type,
                'item_id'   => $item_id,
    ...
    public function TAP_ChargeRedirect(Request $req){
        ...
        if ($err) {
            ...
            $user = \App\Models\Auth\User::find($res->metadata->user_id);
            ...
            if($res->response->code == '000'){ // '000' = Captured
                ...
                if($res->metadata->item_type == 'package'){
                    ...
                    $package = \App\Models\Package\Packages::find($res->metadata->item_id);
                    try{
