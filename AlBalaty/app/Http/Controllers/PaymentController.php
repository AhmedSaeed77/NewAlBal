...
class PaymentController extends Controller
{
    ...
    public function price_details(Request $req){
        ...
        if($priceDetails['localized_price'] == 0){
    ...
    public function payV2(Request $req){
        ...
        * paymentID: details.purchase_units[0].payments.captures[0].id
        ...
        $package = \App\Models\Package\Packages::find($req->input('package_id'));
        ...
        $noti = new \App\Notification;
        $noti->description = 'Paypal Checkout Express: Requested by User: '.Auth::user()->name.'and Accepted, Package: '.\App\Models\Package\Packages::find($req->input('package_id'))->name;
        $noti->save();
