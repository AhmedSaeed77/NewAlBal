...
<?php $__env->startSection('pageTitle'); ?> Add Package <?php $__env->stopSection(); ?>
...
<?php $__env->startSection('subheaderNav'); ?>
    ...
    <!--begin::Button-->
    <a href="#" onclick="AVUtil().redirectionConfirmation('<?php echo e(route('packages.index')); ?>')" class="btn btn-fh btn-white btn-hover-primary font-weight-bold px-2 px-lg-5 mr-2">
    <span class="svg-icon svg-icon-primary svg-icon-lg">
        <!--begin::Svg Icon | path:assets/media/svg/icons/Communication/Add-user.svg-->
        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
            ...
            <div class="card card-custom card-fit card-border">
                <div class="card-header">
                    <div class="card-title">
                        ...
                        <!--end::Svg Icon--></span>
                        <h3 class="card-label"><?php echo e(config('library.path.en')); ?></h3>
                    </div>
                </div>
                <div class="card-body pt-2">
                    <div class="form-grop">
                        <label for=""><?php echo e(config('library.path.en')); ?></label>
                        <select id="paths_list" style="width: 100%;"></select>
                    </div>
                    <div class="form-grop">
                        <label for=""><?php echo e(config('library.course.en')); ?></label>
            ...
            <div class="card card-custom card-fit card-border">
                <div class="card-header">
                    <div class="card-title">
                        ...
                        <h3 class="card-label"><?php echo e(config('library.part.en')); ?> Content</h3>
                    </div>
                </div>
                <div class="card-body pt-2">
                    <div class="form-group">
                        <label><strong><?php echo e(config('library.part.en')); ?></strong></label>
            ...
            methods: {
                ...
                store: async function(){
                    ...
                    await app.storeRequest(data).then((res) => {
                        swal({
                            ...
                            window.location.replace('<?php echo e(route('packages.index')); ?>');
                        });
                    });
                },
                validation: function(){
                    ...
                    if(!app.getDuelListSelected(app.examDuelList)?.length && !app.getDuelListSelected(app.partDuelList)?.length ){
                        this.displayMessage('Please At least One Exam or one <?php echo e(config('library.part.en')); ?>!');
                        return false;
                    }
                ...
                initDropZone: async function(){
                    this.coverImage = new Dropzone('#kt_dropzone_1', {
                        url: "<?php echo e(route('dropzone.handler')); ?>",
