...
<?php $__env->startSection('header'); ?>
    <link href="<?php echo e(asset('assets-admin/css/pages/wizard/wizard-1.css')); ?>" rel="stylesheet" type="text/css" />
...
<?php $__env->startSection('subheaderNav'); ?>
    ...
    <a href="#" onclick="AVUtil().redirectionConfirmation('<?php echo e(route('teacher.index')); ?>')" class="btn btn-fh btn-white btn-hover-primary font-weight-bold px-2 px-lg-5 mr-2">
    <span class="svg-icon svg-icon-success svg-icon-lg">
        <!--begin::Svg Icon | path:assets/media/svg/icons/Communication/Add-user.svg-->
        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                    ...
                    <div class="wizard wizard-1" id="kt_wizard" data-wizard-state="first" data-wizard-clickable="false">
                        ...
                        <div class="row justify-content-center my-10 px-8 my-lg-15 px-lg-10">
                            <div class="col-xl-12 col-xxl-7">
                                <!--begin::Wizard Form-->
                                <form class="form fv-plugins-bootstrap fv-plugins-framework" id="kt_form" method="POST" action="<?php echo e(route('teacher.update', $admin_id)); ?>">
                                    ...
                                    <div class="pb-5" data-wizard-type="step-content">
                                        ...
                                        <div class="form-group">
                                            <label><?php echo app('translator')->getFromJson('NewUser.Management'); ?></label>
                                            ...
                                            <div class="kt-wizard-v4__review-content">
                                                ...
                                                <div class="form-group">
                                                    <table class="table">
                                                        <thead>
                                                        <tr>
                                                            <td><?php echo e(config('library.path.en')); ?></td>
                                                            <td><?php echo e(config('library.course.en')); ?></td>
                                                            <td><?php echo e(config('library.part.en')); ?></td>
                                                        </tr>
                                                        </thead>
                                                        <tbody>
...
<?php $__env->startSection('jscode'); ?>
    <script src="<?php echo e(asset('helper/js/jquery.form.js')); ?>"></script>
    ...
    <script>
        ...
        var KTWizard1 = function () {
            ...
            var app = new Vue({
                el: '#app-1',
                data: {
                    name: '<?php echo e($teacher->name); ?>',
                    phone: '<?php echo e($teacher->phone); ?>',
                    email: '<?php echo e($teacher->email); ?>',
                    country: '<?php echo e($teacher->country); ?>',
                    gender: '<?php echo e($teacher->gender); ?>',
                    ...
                    // ],
                    Permission:[
                        <?php $__currentLoopData = \App\Models\Auth\Permission::all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            '<?php echo e($p->title); ?>',
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    ],
                    Permissions: [],
                ...
                methods: {
                    loaderPermissions:async function(){
                        ...
                        return $.ajax ({
                            type: 'POST',
                            url: '<?php echo e(route('get.teacher.permissions')); ?>',
                            data: {
                                teacher_id: '<?php echo e($admin_id); ?>',
                            },
                    ...
                    UpdatePermissionTable: function(){
                        ...
                        $.ajax ({
                            type: 'POST',
                            url: '<?php echo e(route('get.role.pages')); ?>',
                    ...
                    getManagements:async function(){
                        ...
                        return $.ajax ({
                            type: 'POST',
                            url: '<?php echo e(route('get.roles')); ?>',
                            success: function(res) {
                ...
                btn.on('click', function(e) {
                    ...
                    form.ajaxSubmit({
                        success: function(res) {
                            ...
                            $.ajax({
                                url: "<?php echo e(route('teacher.update', $admin_id)); ?>" ,
                                type: "POST",
                                data: {
                                ...
                                success: function( res ) {
                                    ...
                                    swal({
                                        ...
                                        window.location.href = '<?php echo e(route('teacher.index')); ?>';
                                    });
