                ...
                <div class="card-body">
                    <div class="table-container">
                        <table class="table table-bordered table-hover table-checkable" id="kt_datatable1">
                            ...
                            <?php if(count(\App\Event::where('teacher_id' , Auth::user()->id  )->get()) > 0): ?>
                                <?php $__currentLoopData = \App\Event::where('teacher_id' , Auth::user()->id  )->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $event): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
