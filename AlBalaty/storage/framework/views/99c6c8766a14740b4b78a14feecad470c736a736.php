...
<?php $__env->startSection('pageTitle'); ?> Edit Event <?php $__env->stopSection(); ?>

<?php $__env->startSection('subheaderTitle'); ?> Edit Event <?php $__env->stopSection(); ?>
<?php $__env->startSection('subheaderNav'); ?>
    ...
    <!--begin::Button-->
    <a href="#" onclick="AVUtil().redirectionConfirmation('<?php echo e(route('event.index')); ?>')" class="btn btn-fh btn-white btn-hover-primary font-weight-bold px-2 px-lg-5 mr-2">
    <span class="svg-icon svg-icon-success svg-icon-lg">
        <!--begin::Svg Icon | path:assets/media/svg/icons/Communication/Add-user.svg-->
        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        ...
        <div class="col-md-12">
            ...
            <div class="form-horizontal " style="background: white; padding: 30px 15px;" id="app-1" >
                ...
                <div class="form-group row">
                    <label class="col-2 col-form-label" for="exampleSelectd1" style="text-align: center;"><?php echo e(config('library.path.en')); ?></label>
                    <div class="col-10">
                ...
                <div class="form-group row">
                    <label class="col-2 col-form-label" for="exampleSelectd1" style="text-align: center;"><?php echo e(config('library.course.en')); ?></label>
                    <div class="col-10">
                ...
                <div class="row" >
                    ...
                    <div class="col-md-10">
                        <div class="form-group">
                            <textarea id="description" rows="10" class="form-control"><?php echo $event->description; ?></textarea>
                        </div>
                    </div>
                </div>
                <div class="row" >
                    ...
                    <div class="col-md-10">
                        <div class="form-group">
                            <textarea id="what_you_learn" rows="10" class="form-control"><?php echo $event->what_you_learn; ?></textarea>
                        </div>
                    </div>
                </div>
                <div class="row" >
                    ...
                    <div class="col-md-10">
                        <div class="form-group">
                            <textarea id="requirement" rows="10" class="form-control"><?php echo $event->requirement; ?></textarea>
                        </div>
                    </div>
                </div>
                <div class="row" >
                    ...
                    <div class="col-md-10">
                        <div class="form-group">
                            <textarea id="who_course_for" rows="10" class="form-control"><?php echo $event->who_course_for; ?></textarea>
                        </div>
                    </div>
                </div>
                <div class="row">
                    ...
                    <div class="col-md-10">
                        <div class="form-group">
                            <textarea id="enroll_msg" rows="10" class="form-control" placeholder="English"><?php echo $event->enroll_msg; ?></textarea>
                        </div>
                    </div>
                </div>
                <div class="row" >
                    ...
                    <div class="col-md-10" >
                        <div class="form-group">
                            <select name="free_package_id[]" id="free_package_id" multiple class="form-control" v-model="free_package_id">
                                ...
                                <?php $__currentLoopData = \App\Models\Package\Packages::where('active', 1)->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $c): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <h2>Pricing</h2>
                <hr>
                <?php $__currentLoopData = $prices; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $zone): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="row" >
                        <div class="col-md-2"  style="display:flex; justify-content: center; margin-top:10px;">
                            <b><?php echo e($zone->name); ?> -</b> Price ($) :
                        </div>
                        <div class="col-md-4" >
                            <div class="form-group">
                                <input type="number" v-model="price_zone_<?php echo e($zone->id); ?>" class="form-control">
                            </div>
                        </div>
                        <div class="col-md-2"  style="display:flex; justify-content: center; margin-top:10px;">
                            <b><?php echo e($zone->name); ?> -</b> Discount (%):
                        </div>
                        <div class="col-md-4" >
                            <div class="form-group">
                                <input type="number" v-model="discount_zone_<?php echo e($zone->id); ?>" class="form-control">
                            </div>
                        </div>
                    </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    ...
    <script>
        ...
        var app = new Vue({
            ...
            data: {
                ...
                event_active: <?php if($event->active): ?> true <?php else: ?> false <?php endif; ?>,
                event_title: '<?php echo e($event->name); ?>',
                event_lang: '<?php echo e($event->lang); ?>',

                free_package_id: [
                    <?php $__currentLoopData = \App\EventFreePackage::where('event_id', $event->id)->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $free): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        '<?php echo e($free->package_id); ?>',
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                ],
                ...
                event_price: '<?php echo e($event->original_price); ?>',
                event_discount: '<?php echo e($event->discount); ?>',
                event_picture: '',
                path_id:'<?php echo e($event->path_id); ?>',
                course_id:'<?php echo e($event->course_id); ?>',
                paths: [],
                courses: [],
                total_time: '<?php echo e($event->total_time); ?>',
                total_lecture: '<?php echo e($event->total_lecture); ?>',
                day_day: '',
                whatsapp: '<?php echo e($event->whatsapp); ?>',
                zoom: '<?php echo e($event->zoom); ?>',
                certification: '<?php echo e($event->certification ? 1 : 0); ?>',
                certification_title: '<?php echo e($event->certification_title); ?>',
                ...
                days: [
                        <?php $__currentLoopData = \App\EventTime::where('event_id', $event->id)->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $time): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    {
                        'day': '<?php echo e($time->day); ?>',
                        'from': '<?php echo e($time->from); ?>',
                        'to': '<?php echo e($time->to); ?>',
                    },
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                ],

                <?php $__currentLoopData = $prices; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $zone): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                price_zone_<?php echo e($zone->id); ?>: '<?php echo e($zone->original_price); ?>',
                discount_zone_<?php echo e($zone->id); ?>: '<?php echo e($zone->discount); ?>',
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            },
            mounted(){
            ...
            methods: {
                ...
                storeEvent: function () {
                    ...
                    if(Errors.length == 0){
                        ...
                        <?php $__currentLoopData = $prices; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $zone): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        formdata.append('price_zone_<?php echo e($zone->id); ?>', app.price_zone_<?php echo e($zone->id); ?>);
                        formdata.append('discount_zone_<?php echo e($zone->id); ?>', app.discount_zone_<?php echo e($zone->id); ?>);
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        ...
                        ajax.open("POST" ,"<?php echo e(route('super-admin.event.update')); ?>");
                        ajax.send(formdata);
                        KTApp.blockPage();
                ...
                completeHandler: function(event){
                    ...
                    if( event.target.responseText == 0){
                        ...
                        swal({
                            ...
                            location.replace('<?php echo e(route('super-admin.event.index')); ?>');
                        });
