...
<?php $__env->startSection('pageTitle'); ?> All Questions <?php $__env->stopSection(); ?>
...
<?php $__env->startSection('subheaderNav'); ?>
    <a href="<?php echo e(route('question.create')); ?>" class="btn btn-fh btn-white btn-hover-primary font-weight-bold px-2 px-lg-5 mr-2">
    ...
    <div class="row" id="app-1">
        <div class="col-md-12">
            ...
            <div class="card card-custom">
                ...
                <div class="card-body">
                    <?php echo Form::open(['action'=>'\App\Http\Controllers\Admin\QuestionsController@index', 'method'=>'GET', 'class'=>'', 'style'=>'margin: 10px 0 20px 0;']); ?>
                    ...
                    <div class="row">
                        <div class="form-group col-md-12" style="">
                            <div class="row">
                                ...
                                <div class="col-sm-10">
                                    <?php echo e(Form::text('word', '', ['class' => 'form-control', 'placeholder'=>'Search'])); ?>
                        ...
                        <div class="form-group col-md-12" style="">
                            <div class="row">
                                <div class="col-sm-2">
                                    <strong><?php echo e(config('library.path.en')); ?></strong>
                                </div>
                                <div class="col-sm-10">
                                    <select name="path_id" id="" class="form-control" v-on:change="getCourses" v-model="path_id">
                                        <option value=""></option>
                                        <?php $__currentLoopData = \App\Models\Library\Path::all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div class="form-group col-md-12" style="">
                            <div class="row">
                                <div class="col-sm-2">
                                    <strong><?php echo e(config('library.course.en')); ?></strong>
                                </div>
                                <div class="col-sm-10">
                        ...
                        <div class="form-group col-md-12" style="">
                            <div class="row">
                                <div class="col-sm-2">
                                    <strong><?php echo e(config('library.part.en')); ?></strong>
                                </div>
                                <div class="col-sm-10">
                        ...
                        <div class="form-group col-md-12" style="">
                            <div class="row">
                                <div class="col-sm-2">
                                    <strong><?php echo e(config('library.chapter.en')); ?></strong>
                                </div>
                                <div class="col-sm-10">
                        ...
                        <div class="form-group col-md-12" style="">
                            <div class="row">
                                <div class="col-sm-2">
                                    <strong><?php echo e(config('library.topic.en')); ?></strong>
                                </div>
                                <div class="col-sm-10">
                        ...
                        <div class="form-group col-md-12" style="">
                            <div class="row">
                                <div class="col-sm-2">
                                    <strong><?php echo e(config('library.skill.en')); ?></strong>
                                </div>
                                <div class="col-sm-10">
                ...
                <div class="card-body">
                    <div class="d-flex">
                        <div class="flex-shrink-0 mr-7">
                            ...
                            class="font-size-h3 symbol-label font-weight-boldest" style="line-height: normal;"><?php echo e($q->path_title); ?></span></div>
                        </div>
                                ...
                                <div class="mr-3">
                                    <div class="d-flex flex-wrap my-2">
                                        ...
                                        <a href="#" class="text-muted text-hover-primary font-weight-bold">
                                            ...
                                            <?php echo e($q->part_title); ?>

                                        </a>
                                        <?php endif; ?>
                                        <?php if($q->chapter_title): ?>
                                        <a href="#" class="text-muted text-hover-primary font-weight-bold">
                                            <span class="svg-icon svg-icon-md svg-icon-gray-500 mr-1">
                                                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px"
                                                     height="24px" viewBox="0 0 24 24" version="1.1"><g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd"><polygon points="0 0 24 0 24 24 0 24"></polygon> <rect fill="#000000" opacity="0.3"
                                                                ...
                                                                d="M11.7071032,15.7071045 C11.3165789,16.0976288 10.6834139,16.0976288 10.2928896,15.7071045 C9.90236532,15.3165802 9.90236532,14.6834152 10.2928896,14.2928909 L16.2928896,8.29289093 C16.6714686,7.914312 17.281055,7.90106637 17.675721,8.26284357 L23.675721,13.7628436 C24.08284,14.136036 24.1103429,14.7686034 23.7371505,15.1757223 C23.3639581,15.5828413 22.7313908,15.6103443 22.3242718,15.2371519 L17.0300721,10.3841355 L11.7071032,15.7071045 Z" fill="#000000" fill-rule="nonzero"
                                                                transform="translate(16.999999, 11.999997) scale(1, -1) rotate(90.000000) translate(-16.999999, -11.999997) "></path></g></svg></span>
                                            <?php echo e($q->chapter_title); ?>

                                        </a>
                                        <?php endif; ?>
                                        <?php if($q->topic_title): ?>
                                        <a href="#" class="text-muted text-hover-primary font-weight-bold">
                                            <span class="svg-icon svg-icon-md svg-icon-gray-500 mr-1">
                                                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px"
                                                     height="24px" viewBox="0 0 24 24" version="1.1"><g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd"><polygon points="0 0 24 0 24 24 0 24"></polygon> <rect fill="#000000" opacity="0.3"
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div data-toggle="tooltip" title="" data-placement="left" data-original-title="Created At" class="dropdown dropdown-inline ml-2">
                                            <a href="#" class="text-primary" style="border-right: 1px solid lightgray; padding-right: 5px;">
                                                <?php echo e(\Carbon\Carbon::parse($q->created_at)->diffForHumans()); ?>
                                        ...
                                        <div data-toggle="tooltip" title="" data-placement="left" data-original-title="Last Updated At" class="dropdown dropdown-inline ml-2">
                                            <a href="#" class="text-primary" style="border-right: 1px solid lightgray; padding-right: 5px;">
                                                <?php echo e(\Carbon\Carbon::parse($q->updated_at)->diffForHumans()); ?>

                                            </a>
                                        </div>
                                        <div data-toggle="tooltip" title="" data-placement="left"
                                            data-original-title="
                                            <?php if($q->important == 1): ?>
                                            Important
                                            <?php else: ?>
                                            Not Important
                                            <?php endif; ?>
                                            ...
                                            <div class="dropdown-menu p-0 m-0 dropdown-menu-md dropdown-menu-right" style="">
                                                <ul class="navi">
                                                    ...
                                                    <li class="navi-item"><a
                                                                href="javascript:;" @click.prevent="loader('<?php echo e($q->id); ?>')"
                                                    ...
                                                    <li class="navi-item">
                                                        <a href="#" data-toggle="modal" data-target="#DeleteModal-<?php echo e($q->id); ?>" class="navi-link">
                                                ...
                                                <div class="modal-dialog">
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <p><?php echo strip_tags($q->title); ?></p>
                                                        </div>
                                                        <div class="modal-footer">
                                                            <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                                                            <?php echo Form::open(['action'=>['\App\Http\Controllers\Admin\QuestionsController@destroy', $q->id], 'method'=>'POST']); ?>
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex justify-content-between align-items-center flex-wrap">
                        <div class="d-flex flex-wrap mr-3">
                            <!-- Pagination here -->
                            <?php echo e($questions->appends(request()->all())->links()); ?>

                        </div>
                        <form class="d-flex align-items-center" method="GET" action="<?php echo e(route('question.index')); ?>">
                            ...
                            <span class="text-muted">Displaying <?php echo e($current_page_count); ?> of <?php echo e($questions->total()); ?> records</span>
                        </form>
                    </div>
                    <!--end:: Pagination-->
                </div>
    ...
    <script>
        var app = new Vue({
            ...
            data:{
                ...
                path_id: '<?php echo e(request()->path_id); ?>',
                paths: [],
                course_id: '<?php echo e(request()->course_id); ?>',
                courses: [],
                part_id: '<?php echo e(request()->part_id); ?>',
                parts: [],
                chapter_id: '<?php echo e(request()->chapter_id); ?>',
                chapters: [],
                topic_id: '<?php echo e(request()->topic_id); ?>',
                topics: [],
                skill_id: '<?php echo e(request()->skill_id); ?>',
                skills: [],
                exams: [],
                tags: [],
                exam_id: [],
            ...
            methods:{
                ...
                loader: function(question_id){
                    ...
                    $.ajax ({
                        type: 'POST',
                        url: '<?php echo e(route('question.loader')); ?>',
                        data: {
                            question_id,
                            strip_tags: 1,
                        },
                        success: function(res){
                            ...
                            app.edit_link = '<?php echo e(route('question.edit', '')); ?>/'+question['id'];
