...
<?php $__env->startSection('subheaderNav'); ?>
    ...
    <!--begin::Button-->
    <a href="#" onclick="AVUtil().redirectionConfirmation('<?php echo e(route('super-admin.package-manager.index')); ?>')" class="btn btn-fh btn-white btn-hover-primary font-weight-bold px-2 px-lg-5 mr-2">
    <span class="svg-icon svg-icon-primary svg-icon-lg">
        <!--begin::Svg Icon | path:assets/media/svg/icons/Communication/Add-user.svg-->
        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
            ...
            <div class="card-body">
                <div class="form-group row">
                    ...
                    <div class="col-md-6">
                        ...
                        <p><?php echo e($package->renew_period_in_days ? $package->renew_period_in_days.' Days': 'One Time Payment.'); ?></p>
                    </div>
                </div>
                <div class="form-group row">
                    <div class="col-md-6">
                        <h2 class="text-primary">Teacher Name</h2>
                        <p><?php echo e($package->teacher_name); ?></p>
                    </div>
                    <div class="col-md-6">
                        <h2 class="text-primary">Package Language</h2>
                        <p><?php echo e($package->lang); ?></p>
                    </div>
                </div>
                <div class="form-group row">
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        ...
                        <p><?php echo $package->what_you_learn; ?></p>
                    </div>
                </div>
                <div class="form-group row">
                    <div class="col-md-6">
                        <h2 class="text-primary">Requirement</h2>
                        <p><?php echo $package->requirement; ?></p>
                    </div>
                    <div class="col-md-6">
                        <h2 class="text-primary">Who Course For</h2>
                        <p><?php echo $package->who_course_for; ?></p>
                    </div>
                </div>
...
<?php $__env->startSection('jscode'); ?>
    ...
    <script>
        ...
        var app = new Vue({
            el: '#app1',
            data:{
                approved: <?php echo e($package->approved ? 'true': 'false'); ?>,

                /** Pricing */
                zones: [],
                fallback_price: '<?php echo e($package->pricing['original_price']); ?>',
                fallback_discount: '<?php echo e($package->pricing['localized_onItem_discount']); ?>',
            ...
            methods: {
                storeRequest: async function(data){
                    ...
                    return $.ajax ({
                        type: 'POST',
                        url: '<?php echo e(route('super-admin.package-manager.update', $package_id)); ?>',
                        data,
                        error: function(err){
                            KTApp.unblockPage();
                            console.log(err);
                ...
                store: async function(){
                    ...
                    await app.storeRequest(data).then((res) => {
                        swal({
                            ...
                            window.location.replace('<?php echo e(route('super-admin.package-manager.index')); ?>');
                        });
                    });
                },
                validation: function(){
                ...
                fetchZones: function(){
                    ...
                    return $.ajax ({
                        type: 'POST',
                        url: '<?php echo e(route('zone.fetch')); ?>',
                    });
                },
