...
<?php $__env->startSection('subheaderNav'); ?>
    ...
    <span class="svg-icon svg-icon-success svg-icon-lg">
        ...
        <!--end::Svg Icon-->
    </span>Add New <?php echo e(config('library.exam.en')); ?></a>
<?php $__env->stopSection(); ?>
            ...
            methods: {
                EditTag: function(id){
                    Swal.fire({
                        ...
                        preConfirm:(value) => {
                            return fetch('<?php echo e(route('library.tag.update', '')); ?>/'+ id, {
                                method: 'POST',
                                headers: {
                ...
                deleteTag: function(id){
                    AVUtil().deleteConfirmation('<?php echo e(route('library.tag.destroy', '')); ?>'+'/'+id, function(url){
                        $.ajaxSetup({
                            headers: {
                                'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>',
                            }
                ...
                AddTag: function(){
                    Swal.fire({
                        title: 'Enter New <?php echo e(config('library.tag.en')); ?> Title',
                        input: 'text',
                        inputAttributes: {
                            autocapitalize: 'off'
                        },
                        ...
                        showLoaderOnConfirm: true,
                        preConfirm:(value) => {
                            return fetch('<?php echo e(route('library.tag.store')); ?>', {
                                method: 'POST',
                                headers: {
                                    "Content-Type": "application/json",
                                    'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>',
                        ...
                        preConfirm:(ExamTitle) => {
                            Swal.fire({
                                ...
                                preConfirm: (examDuration) => {
                                    return fetch('<?php echo e(route('library.exam.update', '')); ?>/'+ id, {
                                        method: 'POST',
                                        headers: {
                                            "Content-Type": "application/json",
                                            'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>',
                ...
                deleteExam: function(id){
                    AVUtil().deleteConfirmation('<?php echo e(route('library.exam.destroy', '')); ?>'+'/'+id, function(url){
                            $.ajaxSetup({
                                headers: {
                                    'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>',
                                }
                    ...
                    Swal.fire({
                        ...
                        preConfirm:(ExamTitle) => {
                            Swal.fire({
                                ...
                                allowOutsideClick: () => !Swal.isLoading(),
                                preConfirm: (examDuration) => {
                                    return fetch('<?php echo e(route('library.exam.store')); ?>', {
                                        method: 'POST',
                                        headers: {
                                            "Content-Type": "application/json",
                                            'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>',
