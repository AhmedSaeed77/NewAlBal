...
<head>
  <meta charset="utf-8">
    ...
    <title><?php echo e(env('APP_NAME')); ?> | Student</title>
  ...
  <header class="main-header">
	<div class="d-flex align-items-center logo-box justify-content-start">
		...
		<a href="<?php echo e(route('index')); ?>" class="logo">
		  <!-- logo-->
		  <div class="logo-lg">
		  <img src="<?php echo e(asset('/assets-public/images/logo/logo-dark.png')); ?>" alt="" style="width:70px !important" class="align-self-end w-150">
		  </div>
		</a>	
	</div>  
    <!-- Header Navbar -->
          ...
          <li class="dropdown user user-menu">
            ...
            <ul class="dropdown-menu animated flipInX">
              <li class="user-body">
				 ...
				 <a class="dropdown-item" href="<?php echo e(route('logout')); ?>" onclick="event.preventDefault();document.getElementById('logout-form').submit();"><i class="ti-lock text-muted me-2"></i> Logout</a>
              </li>
            </ul>
          </li>
    ...
    <section class="sidebar position-relative">	
		  ...
		  <div class="multinav-scroll" style="height: 100%;">	
			  ...
			  <ul class="sidebar-menu" data-widget="tree">	
				...
				<li>
					<a href="<?php echo e(route('student.material')); ?>">
						<i class="icon-Layout-4-blocks"><span class="path1"></span><span class="path2"></span></i>
						<span>الموارد التعليمية</span>
					</a>
				</li>
				<li>
					<a href="<?php echo e(route('student.events')); ?>">
						<i class="icon-Layout-4-blocks"><span class="path1"></span><span class="path2"></span></i>
						<span>المراجعات </span>
					</a>
				</li>
