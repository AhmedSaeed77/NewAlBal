<?php $__env->startSection('pageTitle'); ?> Create Event <?php $__env->stopSection(); ?>

<?php $__env->startSection('subheaderTitle'); ?> Create Event <?php $__env->stopSection(); ?>
...
<?php $__env->startSection('content'); ?>
    <div class="card card-custom">
        ...
        <div class="form-horizontal " style="background: white; padding: 30px 15px;" id="app-1" >
            ...
            <h2>Pricing</h2>
            <hr>
            <?php $__currentLoopData = \App\Models\Zone\Zone::all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $zone): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="row" >
                    <div class="col-md-2"  style="display:flex; justify-content: center; margin-top:10px;">
    ...
    <script>
        ...
        var app = new Vue({
            ...
            data: {
                ...
                <?php $__currentLoopData = \App\Models\Zone\Zone::all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $zone): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                price_zone_<?php echo e($zone->id); ?>: '',
                discount_zone_<?php echo e($zone->id); ?>: '',
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            },
            mounted(){
                this.ck_array.event_description = this.initEditor('event_description', 200);
                this.ck_array.event_what_you_learn = this.initEditor('event_what_you_learn', 200);
                this.ck_array.event_requirement = this.initEditor('event_requirement', 200);
                this.ck_array.event_who_course_for = this.initEditor('event_who_course_for', 200);
                this.ck_array.event_enroll_msg = this.initEditor('event_enroll_msg', 200);
                this.getPaths();
            },
            methods: {
                ...
                storeEvent: function () {
                    ...
                    if(Errors.length == 0){
                        ...
                        ajax.open("POST" ,"<?php echo e(route('event.store')); ?>");
                        ajax.send(formdata);
                        KTApp.blockPage();
