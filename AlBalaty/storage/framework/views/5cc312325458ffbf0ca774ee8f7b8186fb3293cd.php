<?php $__env->startSection('pageTitle'); ?> Disabled Users <?php $__env->stopSection(); ?>
<?php $__env->startSection('subheaderNav'); ?>

    <!--begin::Button-->
    <a href="<?php echo e(route('showAllUsers')); ?>" class="btn btn-fh btn-white btn-hover-primary font-weight-bold px-2 px-lg-5 mr-2">
                        ...
                        <div class="col-md-12">
                            <div class="table-responsive ">
                                <table class="table table-bordered table-hover table-checkable" id="kt_datatable1" style="margin-top: 13px !important">
                                    ...
                                    <tbody>
                                    <?php $__currentLoopData = \App\DisabledUser::orderBy('created_at', 'desc')->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
