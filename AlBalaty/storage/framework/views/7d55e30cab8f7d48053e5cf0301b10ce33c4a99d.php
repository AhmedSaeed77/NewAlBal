                                ...
                                <div class="pb-5" data-wizard-type="step-content">
                                    ...
                                    <div class="from-group row">
                                        <div class="col-xl-12">
                                            <!--begin::Input-->
                                            <div class="form-group fv-plugins-icon-container">
                                                <label><?php echo e(config('library.course.en')); ?> Title</label>
                                                <input type="text" class="form-control form-control-solid form-control-lg" v-model="course_title" placeholder="<?php echo e(config('library.course.en')); ?> ..">
                                                <span class="form-text text-muted">Please enter <?php echo e(config('library.course.en')); ?> title.</span>
                                                <div class="fv-plugins-message-container"></div>
                ...
                methods: {
                    store: function(){
                        ...
                        $.ajax ({
                            ...
                            url: '<?php echo e(route('library.store')); ?>',
                            success: function(res){
                                ...
                                swal({
                                    text: '<?php echo e(config('library.path.en')); ?> setup completed.',
                                    type: "success",
                    ...
                    _formEl,
                    {
                        fields: {
                            ...
                            path_title: {
                                validators: {
                                    notEmpty: {
                                        message: '<?php echo e(config('library.path.en')); ?> Title is required.'
                                    }
                                }
                            },
                            country: {
